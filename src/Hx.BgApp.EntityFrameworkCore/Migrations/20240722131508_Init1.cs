        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RELEASE = table.Column<bool>(type: "boolean", nullable: false),
                    RELEASEDATETIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    STARTTIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ENDTIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    VIEWCOUNT = table.Column<int>(type: "integer", maxLength: 5, nullable: false),
                    EXTRAPROPERTIES = table.Column<string>(type: "text", nullable: false),
                    CONCURRENCYSTAMP = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_APP_PUBLISH_FEADBACKINFO", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DEFAULTMENUEXPANDEDLIST = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PAGEPATH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    PROJECTID = table.Column<Guid>(type: "uuid", nullable: false),
                    CODE = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    PARENTID = table.Column<Guid>(type: "uuid", nullable: true),
                    SERIALNUMBER = table.Column<int>(type: "integer", maxLength: 5, nullable: false),
                    CREATIONTIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CREATORID = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_APPMENUS_PROJECTID",
                table: "APPMENUS",
                column: "PROJECTID");

            migrationBuilder.CreateIndex(
                name: "IX_APPPAGES_PROJECTID",
                table: "APPPAGES",
                column: "PROJECTID");
