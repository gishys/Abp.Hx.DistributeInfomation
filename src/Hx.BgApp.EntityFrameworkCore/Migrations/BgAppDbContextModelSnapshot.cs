...
namespace Hx.BgApp.Migrations
{
    ...
    partial class BgAppDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hx.BgApp.Layout.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("Hx.BgApp.Layout.Page", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("Hx.BgApp.Layout.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("ID");
                    ...
                    b.Property<string>("DefaultMenuExpandedList")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("DEFAULTMENUEXPANDEDLIST");
            ...
            modelBuilder.Entity("Hx.BgApp.PublishInformation.PublishFeadbackInfo", b =>
                {
                    ...
                    b.ToTable("APP_PUBLISH_FEADBACKINFO", (string)null);
                });
            ...
            modelBuilder.Entity("Hx.BgApp.Layout.Menu", b =>
                {
                    b.HasOne("Hx.BgApp.Layout.Page", null)
                        .WithOne()
                        .HasForeignKey("Hx.BgApp.Layout.Menu", "PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("MENU_PAGEID");

                    b.HasOne("Hx.BgApp.Layout.Menu", null)
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("MENU_PARENTID");

                    b.HasOne("Hx.BgApp.Layout.Project", null)
                        .WithMany("Menus")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("MENU_PROJECTID");
                });
